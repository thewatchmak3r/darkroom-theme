...
The vault also contains a file (darkroom debug sheet.md) that, as the name implies, serves a debug sheet in case you want to tinker with the css file and customize it to make your own color palette. Just open the css file and the debug sheet at the same time so you can live preview the changes in the code as you save the css file. The images in the vault are screenshots that help you better see where the changes are being made. 
